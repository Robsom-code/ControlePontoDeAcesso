...
import com.robsom.controle.repository.LocalidadeRepository;
...
public class LocalidadeService {
    ...
    public Optional<Localidade> getById(Long idLocalidade) {return localidadeRepository.findById(idLocalidade);
    }
